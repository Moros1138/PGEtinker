...
function compile($code)
{
    ...
    do
    {
        ...
        if(Storage::directoryMissing($directoryName))
        {
    ...
    $compilerProcessResult = Process::env($emscriptenEnvironment)
    ...
    $linkerProcessResult = Process::env($emscriptenEnvironment)
        ->path($workspaceDirectory)
...
{
    $result = compile($request->input("code", null));
    unset($result["hash"]);
